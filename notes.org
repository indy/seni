* TODO [0/8]
  1. [ ] better seni_ga.c::hack_node_to_var (colours, lists, 2d etc)
  2. [ ] unify args to *_pretty_print
  ...
  7. [ ] look at colour palettes in https://www.npmjs.com/package/nice-color-palettes
  8. [ ] look into restrict keyword in C99
...
* naming convention
  ...
  void $NAME_startup() / void $NAME_shutdown()
  ...
  seni_$NAME $NAME_free()
  - deallocates memory for the named struct

  void $NAME_constructor(seni_$NAME *$NAME)
  - function for filling in an already allocated structure (used by pools)

  void $NAME_destructor(seni_$NAME *$NAME)
  - function for running code in a soon to be free'd structure (used by pools)
