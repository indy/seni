...
void flip(senie_vm* vm, senie_fn_info* fn_info, f32 sx, f32 sy, i32* copy) {
  senie_matrix_stack* matrix_stack = vm->matrix_stack;
...
void repeat_symmetry_vertical(senie_vm* vm, i32 fn, i32* copy) {
  senie_program* program = vm->program;
  senie_fn_info* fn_info = &(program->fn_info[fn]);
