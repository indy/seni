...
// NOTE: the keyword.name is pointing to memory that's managed by the seni_word_lut
//
//void declare_keyword(seni_word_lut *wlut, char *name, seni_var *(*function_ptr)(seni_env *, seni_node *))
