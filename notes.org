* TODO [0/16]
  ...
  2. [ ] col/[gs]et-r, g, b, l, a, h, s, v  -- no colour conversion, just works out the correct index
  3. [ ] {red (gen/col alpha: 1)} bug?
  4. [ ] a way of passing arguments to called functions (those that use address-of)
