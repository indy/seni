* TODO [0/6]
  1. [ ] maybe have a required specifier in functions?
  2. [ ] poly should also accept a uv parameter
  3. [ ] ensure that there's a dist folder before running npm run build:wasm
  4. [ ] remove hsv colour space? - would this get rid of the illegal state?
  5. [ ] look at colour palettes in https://www.npmjs.com/package/nice-color-palettes
  6. [ ] look into restrict keyword in C99
