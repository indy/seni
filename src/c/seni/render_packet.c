...
sen_render_packet* render_packet_allocate(i32 max_vertices, i32 vbuf_element_size,
                                          i32 cbuf_element_size, i32 tbuf_element_size) {
  sen_render_packet* render_packet = (sen_render_packet*)calloc(1, sizeof(sen_render_packet));
...
sen_render_data* render_data_allocate(i32 max_vertices) {
  sen_render_data* render_data = (sen_render_data*)calloc(1, sizeof(sen_render_data));
...
sen_render_packet* add_render_packet(sen_render_data* render_data) {
  ...
  sen_render_packet* render_packet =
      render_packet_allocate(render_data->max_vertices, render_data->vbuf_element_size,
