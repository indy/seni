* TODO [0/15]
  1. [ ] fix path/ functions (step arg)
  2. [ ] test vector/append
  3. [ ] test gc
  4. [ ] look into replacing append_to_vector with append_heap_var_to_vector
  5. [ ] maybe have a required specifier in functions?
  6. [ ] fence keyword? (fencepost version of loop) (fence from: 0 to: 10 steps: 11)
