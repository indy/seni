* TODO [0/11]
  ...
  4. [ ] ensure that there's a dist folder before running npm run build:wasm
  5. [ ] test new setup/teardown code
  6. [ ] cleanup memory of parser
  7. [ ] structs for compile, runtim, performance info
  8. [ ] seni_env
