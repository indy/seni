* TODO [0/6]
  1. [ ] structs for compile info and runtime info
  2. [ ] seni_env
  3. [ ] interp/fn interp/bezier
  4. [ ] 'in' paramaeter for loop ?
  5. [ ] how would a stack machine compile first class functions? could there be alternatives?
  6. [ ] remove hsv colour space? - would this get rid of the illegal state?


during compilation, have a preamble phase in which the globals are defined
