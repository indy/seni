* TODO [0/14]
  1. [ ] bind_gen_col set min/max according to colour format
  2. [ ] 161g-grid-flow (shows evolve mismatched rendering error)
  3. [ ] quilt
  4. [ ] map (1669-zero.senie)
  5. [ ] better error messages when gen/scalar was mis-spelt
  6. [ ] {red (gen/col alpha: 1)} bug?
  7. [ ] poly should also accept a uv parameter
  8. [ ] remove vm/env from genotype_list_create_initial_generation
  9. [ ] impl: initial seed
  10. [ ] add an END token to serialized output, use as a sanity check?
  11. [ ] add unit tests for compiling with a genotype
  12. [ ] ensure that there's a dist folder before running npm run build:wasm
  13. [ ] look at colour palettes in https://www.npmjs.com/package/nice-color-palettes
  14. [ ] look into restrict keyword in C99
...
* updating scripts [55/57]
  1. [X] 14ef-blur-grid.senie
  2. [X] 14eg-marker-grid.senie
  3. [X] 14eh-chaotic-grid.senie
  4. [X] 14fh-rothko-1.senie
  5. [X] 151c-flower.senie - bezier-bulging
  6. [X] 1531-four-squares.senie
  7. [X] 154c-stroked-bezier.senie
  8. [X] 154h-rothko-2.senie -- TODO: THIS IS SLOW
  9. [X] 1556-biomorphs.senie - repeat/symmetry-vertical - takes a 'draw' argument
  10. [X] 155b-spiral-derived.senie - path/circle
  11. [X] 155j-chaotic-grid-2.senie - focal/point
  12. [X] 155j-chaotic-grid-3.senie
  13. [X] 1560-path.senie - make a function ???
  14. [X] 1565-hex-grid.senie
  15. [X] 156h-tri-grid.senie
  16. [X] 157e-tile-shadow.senie - col/procedural-fn
  17. [ ] 1580-quilt.senie
  18. [X] 1585-seeds.senie
  19. [X] 15fe-rotate-mirror.senie - poly, repeat/rotate-mirrored, vector/append
  20. [X] 15h3-polychrome.senie
  21. [X] 15h3-rotate-mirror-2.senie
  22. [X] 15h3-tri-grid.senie
  23. [X] 15h4-chromatic-layers-1.senie
  24. [X] 15h4-chromatic-layers-2.senie
  25. [X] 15h4-chromatic-layers-3.senie
  26. [X] 15h4-mirror-layers.senie - todo: look into banding issue
  27. [X] 15h4-rotate-mirror.senie
  28. [X] 15he-cos-1.senie
  29. [X] 15he-cos-2.senie
  30. [X] 15he-cos-3.senie
  31. [X] 15he-mirror-layers.senie
  32. [X] 15he-rotate-mirror.senie
  33. [X] 160c-schotter.senie
  34. [X] 161g-grid-flow.senie
  35. [X] 161j-trump.senie
  36. [X] 1626-embers.senie
  37. [X] 1626-orchid.senie
  38. [X] 162e-alien.senie
  39. [X] 162e-mask.senie
  40. [X] 162e-slice.senie
  41. [X] 162e-star.senie
  42. [X] 162e-x.senie
  43. [X] 1632-star.senie
  44. [X] 1633-dune.senie
  45. [X] 1633-orchid.senie
  46. [X] 1633-petal.senie
  47. [X] 1634-cryst.senie
  48. [X] 1638-night.senie
  49. [X] 163a-scale-green.senie
  50. [X] 1642-book-stack.senie
  51. [X] 1642-stacks.senie
  52. [X] 1643-hyp.senie
  53. [X] 1643-paren.senie
  54. [X] 1643-rose.senie
  55. [X] 1643-thorn.senie
  56. [X] 1648-chalk-boxes.senie
  57. [ ] 1669-zero.senie - map


* senie_env

  standard universal bindings (done once, immutable, applied to all compiled/executed programs)
  e.g. the standard api functions in senie_env
  ...
  initvm
    ...
    vm = wrenNewVM(configuration)
      ...
      wrenInitializeCore                <<<-- wren_core.c
        ...
        PRIMITIVE macro ?
        all the core primitives (keywords in senie?) have now been defined
...
* compiling function calls - TODO write up about implementation
  ...
  address-of : works at compile time to LOAD the senie_fn_info index onto the stack. This means that address-of can only work with user-defined functions that are explicitly passed in.
...
* genetic algorithm [0/5]
  ...
  1. [ ] serialise/deserialise senie_trait + senie_program + senie_bytecode + senie_var
...
senie_vm variables used by get_global_mapping?
