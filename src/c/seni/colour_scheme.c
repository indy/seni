...
sen_colour* add_angle_to_hsluv(sen_colour* out, sen_colour* in, f32 delta) {
  i32 H = 0;

  sen_colour_format original_format = in->format;
...
//
void pair(sen_colour* out0, sen_colour* out1, sen_colour* in, f32 ang) {
...
void colour_bezier(sen_colour* out, sen_colour_fn_state* colour_fn_state, f32 t) {
  ...
  // assuming that sen_bind is using RGB colour space
