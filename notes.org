* TODO [0/13]
  1. [ ] test gc
  2. [ ] look into replacing append_to_vector with append_heap_var_to_vector
  3. [ ] maybe have a required specifier in functions?
  4. [ ] fence keyword? (fencepost version of loop) (fence from: 0 to: 10 steps: 11)
  5. [ ] poly should also accept a uv parameter
