...
senie_colour* add_angle_to_hsluv(senie_colour* out, senie_colour* in, f32 delta) {
  i32 H = 0;

  senie_colour_format original_format = in->format;
...
//
void pair(senie_colour* out0, senie_colour* out1, senie_colour* in, f32 ang) {
...
void colour_bezier(senie_colour* out, senie_colour_fn_state* colour_fn_state, f32 t) {
  ...
  // assuming that senie_bind is using RGB colour space
