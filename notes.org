* TODO [0/14]
  1. [ ] look at, test properly and document 'fence' and 'step'
  2. [ ] a way of passing arguments to called functions (those that use address-of)
  3. [ ] {red (gen/col alpha: 1)} bug?
  ...
  10. [ ] unify args to *_pretty_print
  11. [ ] maybe have a required specifier in functions?
