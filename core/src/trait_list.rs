...
mod tests {
    ...
    fn pack_unpack_trait_list() {
        ...
        assert_eq!(packed, "42 0 2 0 0 FLOAT 50 7 JUMP INT 1 INT 0 LOAD MEM 3 INT 269 LOAD MEM 3 FLOAT 30 LOAD MEM 3 INT 268 LOAD MEM 3 FLOAT 60 BUILTIN BUILTIN gen/scalar INT 2 STOP INT 0 INT 0 0 0 FLOAT 10 7 JUMP INT 1 INT 0 LOAD MEM 3 INT 269 LOAD MEM 3 FLOAT 5 LOAD MEM 3 INT 268 LOAD MEM 3 FLOAT 20 BUILTIN BUILTIN gen/scalar INT 2 STOP INT 0 INT 0");
    ...
    fn pack_unpack_trait_list_2() {
        ...
        assert_eq!(packed, "42 3 0 13 1 14 2 15 2 0 0 FLOAT 50 7 JUMP INT 1 INT 0 LOAD MEM 3 INT 269 LOAD MEM 3 FLOAT 30 LOAD MEM 3 INT 268 LOAD MEM 3 FLOAT 60 BUILTIN BUILTIN gen/scalar INT 2 STOP INT 0 INT 0 0 0 FLOAT 10 7 JUMP INT 1 INT 0 LOAD MEM 3 INT 269 LOAD MEM 3 FLOAT 5 LOAD MEM 3 INT 268 LOAD MEM 3 FLOAT 20 BUILTIN BUILTIN gen/scalar INT 2 STOP INT 0 INT 0");
