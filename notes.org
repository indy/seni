* TODO [0/9]
  1. [ ] web assembly lives inside a web worker
  2. [ ] test gc
  ...
  7. [ ] remove hsv colour space? - would this get rid of the illegal state?
  8. [ ] look at colour palettes in https://www.npmjs.com/package/nice-color-palettes
  9. [ ] look into restrict keyword in C99
...
* genetic algorithm [0/2]
  ...
  1. [ ] serialise a genotype
  2. [ ] deserialise a genotype
