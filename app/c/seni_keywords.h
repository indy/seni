...
REGISTER_KEYWORD("math/distance", INAME_MATH_DISTANCE)
REGISTER_KEYWORD("math/clamp", INAME_MATH_CLAMP)
REGISTER_KEYWORD("val", INAME_VAL)
...
REGISTER_KEYWORD("using", INAME_USING)
