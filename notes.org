* TODO [1/13]
  1. [ ] pretty print program emits names
  2. [ ] delete seni/seni files
  3. [ ] col/procedural-fn-presets
  4. [ ] impl: random_crossover(seni_genotype *a, seni_genotype *b, i32 genotype_length)
  5. [ ] better seni_ga.c::hack_node_to_var (colours, lists, 2d etc)
  6. [X] does ( + 1 1) work? (space between list start and function name)
