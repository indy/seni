 ...
 *
 * JavaCL / LibCL (Olivier Chafik, 2011) : adapted from strod.c copied from
 *FreeBSD
 *
 */
...
int senie_isspace(char c) { return c == ' ' || c == '\t' || c == '\n' || c == '\r' || c == ','; }

int senie_isdigit(char c) { return c >= '0' && c <= '9'; }

float senie_strtof(char* string, /* A decimal ASCII floating-point number,
